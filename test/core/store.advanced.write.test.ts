 ...
 *
 * Comprehensive test suite for the Universal Store's advanced features including:
  ...
  describe("Thunk Actions", () => {
    ...
    describe("Synchronous Thunks", () => {
      ...
      it("should return the thunk result for sync thunks", () => {
        ...
        const syncThunk: Thunk<ThunkTestState, string> = (
          dispatch,
          getState
        ) => {
    ...
    describe("Asynchronous Thunks", () => {
      it("should execute an asynchronous thunk and update state", async () => {
        ...
        const asyncThunk: Thunk<ThunkTestState, Promise<void>> = async (
          dispatch,
          getState
        ) => {
          dispatch({ status: "pending" });
      ...
      it("should handle async thunk errors properly", async () => {
        ...
        await expect(store.dispatch(erroringAsyncThunk)).rejects.toThrow(
    ...
    describe("Thunk Return Values", () => {
      ...
      it("should return primitive values from synchronous thunks", () => {
        ...
        // Number return value
        const numberThunk: Thunk<ThunkTestState, number> = (
          dispatch,
          getState
        ) => {
        ...
        const booleanThunk: Thunk<ThunkTestState, boolean> = (
          dispatch,
          getState
        ) => {
      ...
      it("should return object values from synchronous thunks", () => {
        ...
        const objectThunk: Thunk<ThunkTestState, OperationResult> = (
          dispatch,
          getState
        ) => {
      ...
      it("should return array values from synchronous thunks", () => {
        const arrayThunk: Thunk<ThunkTestState, string[]> = (
          dispatch,
          getState
        ) => {
          const state = getState();
      ...
      it("should handle chained thunks with return values", () => {
        const firstThunk: Thunk<
          ThunkTestState,
          { step: number; data: string }
        > = (dispatch, getState) => {
    ...
    describe("Thunk Error Handling", () => {
      ...
      it("should handle errors with custom error handling", () => {
        ...
        expect(errorArg.context?.error?.message).toBe(
  ...
  describe("Transaction Operations", () => {
    ...
    describe("Transaction Performance and Optimization", () => {
      it("should handle large state mutations efficiently", () => {
        ...
        expect(largeStore.getState().metadata?.lastTransaction).toBe(
          "bulk-update"
        );
      });
    });
